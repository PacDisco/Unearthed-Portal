...
// submitter typed, so matching one address meant each half of a household saw
// half the documents — a parent who uploaded the passport left the student's
// own portal showing nothing, so the student uploaded it again. The audience
// is now the household (_shared/household.js: contacts on the student's
// deals, plus contacts linked to them with a household association label),
// and each document says who submitted it.
//
...
//               unchanged: your own, unless you're an admin.
